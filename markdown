...
12. Ensure `LightSource` positions are updated correctly if attached to moving entities (e.g., in `LightSource.update` or `EntityManager.update`). (**COMPLETE - Implemented vehicle headlights with offsets**)

---

**Phase 5: Shadow Implementation (Advanced - NEXT)**
